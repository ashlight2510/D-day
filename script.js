const translations = {
    ko: {
        metaTitle: 'D-day 계산기 | 디데이 날짜 계산기 - 목표일까지 무료 계산',
        metaDescription:
            '무료 D-day 계산기로 목표일까지 며칠 남았는지 쉽고 빠르게 계산하세요. 생일, 기념일, 시험일, 프로젝트 마감일 등 모든 중요한 날짜를 관리하고 카운트다운하세요.',
        metaKeywords:
            'D-day, 디데이, 날짜계산, 카운트다운, 기념일, 생일, 시험일, 디데이 계산기, 날짜 계산기, 목표일, 남은 날짜',
        metaOgTitle:
            'D-day 계산기 | 디데이 날짜 계산기 - 무료로 목표일까지 며칠 남았는지 계산',
        metaOgDescription:
            '무료 D-day 계산기로 목표일까지 며칠 남았는지 쉽고 빠르게 계산하세요. 생일, 기념일, 시험일 등 모든 중요한 날짜를 관리하세요.',
        metaTwitterTitle: 'D-day 계산기 | 디데이 날짜 계산기',
        metaTwitterDescription:
            '무료 D-day 계산기로 목표일까지 며칠 남았는지 쉽고 빠르게 계산하세요.',
        ogSiteName: 'D-day 계산기',
        ogLocale: 'ko_KR',
        ...
        navContact: '문의',
        heroTitle: '📅 D-day 계산기',
        heroSubtitle: '목표일까지 며칠 남았는지 쉽고 빠르게 계산하세요',
        themePurple: '보라색 테마',
        themeBlue: '파란색 테마',
        themeGreen: '초록색 테마',
        themePink: '핑크 테마',
        themeOrange: '오렌지 테마',
        introTitle: 'D-day 계산기로 목표일을 관리하세요',
        introDesc1:
            '생일, 기념일, 시험일, 프로젝트 마감일 등 모든 중요한 날짜를 쉽고 빠르게 계산하고 관리할 수 있는 무료 웹 도구입니다. 복잡한 설치나 회원가입 없이 바로 사용할 수 있으며, 모든 기능을 완전 무료로 제공합니다.',
        introDesc2:
            'D-day 계산기는 단순히 날짜를 계산하는 것을 넘어, 목표를 향한 여정을 함께합니다. 실시간 카운트다운, 상세한 시간 표시, 알림 기능, 메모 작성 등 다양한 기능을 통해 중요한 날짜를 놓치지 않고 준비할 수 있도록 도와드립니다.',
        introCard1Title: '✅ 완전 무료',
        introCard1Desc:
            '회원가입이나 결제 없이 모든 기능을 무료로 사용할 수 있습니다.',
        introCard2Title: '🔒 프라이버시 보호',
        introCard2Desc:
            '모든 데이터는 브라우저에만 저장되며 서버로 전송되지 않습니다.',
        introCard3Title: '📱 모든 기기 지원',
        introCard3Desc:
            '스마트폰, 태블릿, PC 등 모든 기기에서 최적화된 화면으로 사용 가능합니다.',
        ddayTitle: '🎯 목표일까지 며칠 남았나요?',
        ddayTargetLabel: '목표 날짜',
        ddayCalculate: '계산하기',
        futureTitle: '📆 N일 후는 언제인가요?',
        futureDaysLabel: '며칠 후',
        futureDaysPlaceholder: '일 수를 입력하세요',
        futureStartLabel: '시작 날짜',
        futureCalculate: '계산하기',
        quickTitle: '⚡ 빠른 계산',
        quick50: '50일 후',
        quick100: '100일 후',
        quick200: '200일 후',
        quick300: '300일 후',
        memoTitle: '✍️ 메모 / 각오 작성',
        memoLabel: '오늘의 각오나 메모를 남겨보세요',
        memoPlaceholder: '예: 시험까지 79일 남았다. 오늘은 2시간 공부했다',
        memoSave: '저장하기',
        memoLoad: '저장된 메모 보기',
        widgetTitle: '🔗 블로그용 위젯 코드 생성',
        widgetDesc: '블로그나 카페에 D-day 위젯을 붙여보세요!',
        widgetDateLabel: '위젯에 표시할 날짜',
        widgetTitleLabel: '위젯 제목',
        widgetTitlePlaceholder: '예: 시험일까지',
        widgetGenerate: '위젯 코드 생성',
        faqTitle: '❓ 자주 묻는 질문 (FAQ)',
        faq1Question: 'Q. D-day 계산기는 무료인가요?',
        faq1Answer:
            'A. 네, 완전 무료입니다. 회원가입이나 설치 없이 바로 사용할 수 있습니다. 모든 기능을 무료로 이용하실 수 있습니다.',
        faq2Question: 'Q. 입력한 날짜와 메모는 어디에 저장되나요?',
        faq2Answer:
            'A. 모든 데이터는 사용자의 브라우저 로컬 스토리지에만 저장됩니다. 서버로 전송되지 않으며, 다른 사람이 접근할 수 없습니다. 브라우저 캐시를 삭제하면 저장된 데이터도 함께 삭제됩니다.',
        faq3Question: 'Q. 모바일에서도 사용할 수 있나요?',
        faq3Answer:
            'A. 네, 반응형 디자인으로 구현되어 있어 스마트폰, 태블릿, 데스크톱 등 모든 기기에서 최적화된 화면으로 사용할 수 있습니다. 모바일 브라우저에서도 모든 기능을 정상적으로 사용할 수 있습니다.',
        faq4Question: 'Q. 위젯 코드를 블로그에 사용해도 되나요?',
        faq4Answer:
            'A. 네, 자유롭게 사용하실 수 있습니다. 개인 블로그, 카페, 웹사이트 등 어디에든 위젯 코드를 삽입하여 사용하실 수 있습니다. 상업적 목적의 사용도 가능합니다.',
        faq5Question: 'Q. 알림 기능이 작동하지 않아요',
        faq5Answer:
            'A. 알림 기능을 사용하려면 브라우저에서 알림 권한을 허용해야 합니다. 브라우저 설정에서 알림 권한을 확인해 주세요. 또한 일부 브라우저나 모바일 환경에서는 알림이 제한될 수 있습니다.',
        faq6Question: 'Q. D-day 계산은 어떻게 하나요?',
        faq6Answer:
            'A. 목표 날짜를 선택하고 "계산하기" 버튼을 클릭하면 됩니다. 오늘부터 목표일까지 며칠 남았는지 자동으로 계산되며, 일, 시간, 분, 초 단위로 상세하게 표시됩니다.',
        faqMore: '더 많은 질문이 있으신가요?',
        faqContact: '문의하기',
        ...
        footerContact: '문의',
        footerSitemap: '사이트맵',
        alertSelectTarget: '목표 날짜를 선택해주세요.',
        alertInvalidDays: '올바른 일 수를 입력해주세요.',
        alertMemoEmpty: '메모를 입력해주세요.',
        alertMemoSaved: '메모가 저장되었습니다!',
        alertMemoEmptyList: '저장된 메모가 없습니다.',
        alertMemoDeleteConfirm: '이 메모를 삭제하시겠습니까?',
        alertSelectDate: '날짜를 선택해주세요.',
        alertWidgetCopied: '코드가 클립보드에 복사되었습니다!',
        alertShareImageDownload: '이미지를 다운로드했습니다. 카카오톡에서 공유해주세요!',
        alertImageDownload: '이미지를 다운로드했습니다.',
        alertImageDownloadInsta:
            '이미지를 다운로드했습니다. 인스타그램 앱에서 업로드해주세요!',
        alertImageGenerateFail: '이미지 생성에 실패했습니다. 다시 시도해주세요.',
        alertImageGenerateError: '이미지 생성 중 오류가 발생했습니다. 다시 시도해주세요.',
        alertImageCopySuccess: '이미지가 클립보드에 복사되었습니다!',
        alertImageCopyFail: '클립보드 복사에 실패했습니다. 이미지를 다운로드했습니다.',
        alertClipboardUnsupported:
            '이 브라우저는 클립보드 복사를 지원하지 않습니다. 이미지를 다운로드했습니다.',
        alertImageCopyError: '이미지 복사 중 오류가 발생했습니다. 다시 시도해주세요.',
        alertImageDataFail: '이미지 생성에 실패했습니다.',
        alertImageDownloadError: '이미지 다운로드 중 오류가 발생했습니다.',
        shareKakaoTitle: 'D-day 계산기',
        shareMemoTitle: '📝 D-day 메모',
        shareKakaoText: '{date}까지 D-{days}',
        shareKakaoFutureText:
            '{startDate}로부터 {days}일 후는 {futureDate}입니다!',
        shareImageCopied: '이미지를 다운로드했습니다. 카카오톡에서 공유해주세요!',
        shareCopyFallback: '클립보드 복사에 실패했습니다. 이미지를 다운로드했습니다.',
        shareTitleDefault: 'D-day',
        unitDay: '일',
        unitHour: '시간',
        unitMinute: '분',
        unitSecond: '초',
        ddayTodayTitle: '🎉 오늘이 바로 목표일입니다!',
        ddayTodayText: '축하합니다! 오늘이 바로 그 날입니다! 🎊',
        ddayArrivedTitle: '🎉 목표일이 도착했습니다!',
        ddayArrivedText: '축하합니다! 목표일이 되었습니다! 🎊',
        ddayTargetTitle: '📅 목표일',
        ddayUntilText: '{date}까지 남았습니다.',
        ddayPastText: '{date}로부터 {days}일 지났습니다.',
        futureResultTitle: '📆 {days}일 후',
        futureResultText: '{startDate}로부터 {days}일 후입니다.',
        quickResultTitle: '⚡ {period}',
        shareKakaoBtn: '💬 카카오톡 공유',
        shareInstagramBtn: '📷 인스타그램 공유',
        shareCopyBtn: '📋 이미지 복사',
        memoShareKakao: '💬 카톡 공유',
        memoShareInsta: '📷 인스타 공유',
        memoShareCopy: '📋 이미지 복사',
        memoDelete: '삭제',
        widgetPreviewTitle: '위젯 미리보기',
        widgetCodeTitle: 'HTML 코드',
        widgetCopyBtn: '코드 복사',
        widgetPreviewLabel: '{title}까지',
        notificationTitle: 'D-day 알림',
        notification100: '{date}까지 100일 남았습니다!',
        notification30: '{date}까지 30일 남았습니다!',
        notification7: '{date}까지 7일 남았습니다!',
        dailyQuotes: [
            '오늘도 목표를 향해 한 걸음씩! 💪',
            '작은 시작이 큰 변화를 만듭니다 ✨',
            '시간은 금이다. 소중하게 사용하세요 ⏰',
    ...
    en: {
        ...
        widgetTitle: '🔗 Widget code for blogs',
        ...
        unitMinute: 'minutes',
        unitSecond: 'seconds',
        ddayTodayTitle: '🎉 Today is the target day!',
        ddayTodayText: 'Congrats! Today is the day! 🎊',
        ddayArrivedTitle: '🎉 Your target day has arrived!',
        ddayArrivedText: 'Congrats! It is your target day! 🎊',
        ddayTargetTitle: '📅 Target date',
        ddayUntilText: 'Until {date}.',
        ddayPastText: 'It has been {days} days since {date}.',
        futureResultTitle: '📆 {days} days later',
        futureResultText: '{futureDate} is {days} days after {startDate}.',
        quickResultTitle: '⚡ {period}',
        shareKakaoBtn: '💬 Share to Kakao',
        shareInstagramBtn: '📷 Share to Instagram',
        shareCopyBtn: '📋 Copy image',
        memoShareKakao: '💬 Share',
        memoShareInsta: '📷 Instagram',
        memoShareCopy: '📋 Copy image',
        memoDelete: 'Delete',
        ...
        dailyQuotes: [
            'One step closer to your goal today! 💪',
            'Small starts create big changes ✨',
            'Time is gold. Use it wisely ⏰',
            'Today is the day to begin! 🌟',
            'Keep going toward your goal today! 🚀',
            'Every day is precious time 📅',
            'Wishing you a day that moves you toward your dream 🌈'
        ]
    }
};
...
function applyStructuredData() {
    ...
    if (structured) {
        const data = {
            ...
            featureList: [
                currentLang === 'en' ? 'D-day countdown' : 'D-day 계산',
                currentLang === 'en' ? 'Reverse calculation' : '역계산 기능',
                currentLang === 'en' ? 'Quick calc' : '빠른 계산',
                currentLang === 'en' ? 'Memo notes' : '메모 작성',
                currentLang === 'en' ? 'Notifications' : '알림 기능',
                currentLang === 'en' ? 'Share image' : '공유 이미지 생성'
            ]
        };
